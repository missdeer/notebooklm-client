...
- **TypeScript** (`notebooklm-client-ts/`): The original, full-featured implementation. Published as npm package `notebooklm-client`. See `notebooklm-client-ts/AGENTS.md` for TS-specific details.
